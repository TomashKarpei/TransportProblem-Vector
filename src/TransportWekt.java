...
public class TransportWekt {
	...
	public static void main(String[] args) {
		 ...
		 boolean min = true; 
		 int il_p_nad = 5, il_p_odbioru = 6, il_osob = 10, elitKr = 3, il_epok = 100;
		 ...
		 int[] zapasy = { 20, 20, 5, 10, 15 };
		 int[] zapotrzeb = { 5, 15, 15, 10, 5, 20 };
		 ...
		 int stat_f_oceny [] = new int [il_osob];
		 int stat_tablica [][][] = new int [il_osob][zapasy.length][zapotrzeb.length];
		 
		 ////epoki
		 for (int z = 0; z < il_epok+1; z++) {
			 int temp_i = 0, temp_j = 0;
			 int t_max = 0;
			 int f_oceny [] = new int [il_osob*elitKr];
			 int tablica [][][] = new int [il_osob*elitKr][zapasy.length][zapotrzeb.length];
			 ...
			 for (int n = 0; n < il_osob; n++) {
				 ...
				 int[] temp_zapas =  { 20, 20, 5, 10, 15 };
				 int[] temp_zapot = { 5, 15, 15, 10, 5, 20 };
				 //temp_zapas = zapasy;
				 ...
				 for (int k = 0; k < il_poz; k++) {
					 ...
					 //System.out.println(temp_zapas[temp_i] + " " + temp_zapot[temp_j]);
			 ...
			 for (int n = 0; n < il_osob*elitKr; n++) {
				 ...
				 for (int j = 0; j < ilTurn; j++) {
					 ...
					 System.out.println ("Wylosowana liczba turniejowa: " + liczbTurn[j] + ". Funkcja oceny tej liczby: " + fOcTurn[j]);
	         	 }
				 System.out.println ("Wylosowana minimalna liczba turniejowa nr " + n +" : " + min_id[n] + ". Funkcja oceny tej liczby: " + tempFunkOc[n]);			 
				 for (int k = 0; k < il_poz; k++) {
				...
				if (losIlRodz > 1) {
			        ...
			        for (int i = 0; i < losIlRodz; i++) {
			        	if (i%2 == 0) {		        			        	
				        	...
				        	System.out.println("losowany punkt 1 = "+ losPunkt1 + ", Losowany punkt 2 = " + losPunkt2 + "\n");
			        	}
